...
my_pvolfiles <- list.files(recursive = TRUE, full.names = FALSE, pattern="KINX")
...
my_ppi_clean <- calculate_param(my_ppi, RHOHV = ifelse(CELL >= 1, NA, RHOHV))
my_ppi_clean <- calculate_param(my_ppi, VRADH = ifelse(CELL >= 1, NA, VRADH))
...
day with lots of bird migration
regular day insect activity
insect migrating in front



For our animal classification algorithm, we propose to use data from multiple years across 3 countries (NL, BE, DE). 
