...
my_pvolInsMig<-read_pvolfile(insectmigrationOK[2])%>%
  get_scan( 0.5)
plot(project_as_ppi(my_pvolInsMig, range_max = 150000),  param="DBZH")
...
my_pvolInsEmerg<-read_pvolfile(insectemergenceWI[2])%>%
  get_scan( 0.5)
plot(project_as_ppi(my_pvolInsEmerg, range_max = 150000),  param="DBZH")
...
my_pvolBirdMig<-read_pvolfile(birdmigrationOK[1])%>%
  get_scan( 0.5)
plot(project_as_ppi(my_pvolBirdMig, range_max = 150000),  param="DBZH")
